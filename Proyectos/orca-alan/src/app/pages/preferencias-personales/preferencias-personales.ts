...
@Component({
  selector: 'app-preferencias-personales',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  template: `
    ...
    <div class="preferencias-page">
      ...
      <div class="page-header">
        ...
        <p class="subtitle">Configura tus preferencias de notificaciones</p>
      </div>
...
export class PreferenciasPersonalesComponent implements OnInit, OnDestroy {
